<template>
    <div class="fillcontain">
        ...
        <div class="table_container">
            ...
            >
                <!-- <el-table-column type="expand" v-if="adminInfo.type == 0">
                ...
                <el-table-column label="围栏数据" prop="rating">
                </el-table-column>
        ...
        async updateShop() {
            ...
            try {
                ...
                if (this.actionType === "add") {
                    console.log(this.selectTable, "----add");
